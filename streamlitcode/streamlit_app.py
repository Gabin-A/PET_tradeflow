...
@st.cache_data
def load_392062():
    df = pd.read_excel("PET_flow/total_392062.xlsx", sheet_name="Sheet1")
    df = df.rename(columns={
        "ReporterName": "Country",
        "PartnerName": "Partner",
        "TradeValue in 1000 USD": "Value",
...
@st.cache_data
def load_392330():
    df = pd.read_excel("PET_flow/total_392330.xlsx", sheet_name="Sheet1")
    df = df.rename(columns={
        "ReporterName": "Country",
        "PartnerName": "Partner",
        "TradeValue in 1000 USD": "Value",
...
@st.cache_data
def load_391590():
    df = pd.read_excel("PET_flow/total_391590.xlsx", sheet_name="Sheet1")
    df = df.rename(columns={
        "ReporterName": "Country",
        "PartnerName": "Partner",
        "TradeValue in 1000 USD": "Value",
...
@st.cache_data
def load_291736():
    df = pd.read_excel("PET_flow/total_291736.xlsx", sheet_name="Sheet1")
    df = df.rename(columns={
        "ReporterName": "Country",
        "PartnerName": "Partner",
        "TradeValue in 1000 USD": "Value",
